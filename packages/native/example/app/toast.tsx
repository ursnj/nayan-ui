...
export default function ToastScreen() {
  ...
  return (
    <Screen title="useNToast">
      ...
      <NButton
        variant="outline"
        onPress={() => toast.success("Your profile has been updated.", "Profile")}
      >
        Success with title
      </NButton>
      <NButton
        variant="outline"
        onPress={() => toast.error("Please check your connection.", "Network")}
      >
        Error with title
      </NButton>
      ...
      <NButton
        variant="outline"
        onPress={() =>
          toast.show({ type: "info", title: "Custom", message: "Using toast.show() directly." })
        }
      >
        toast.show()
      </NButton>
