...
const screens: ScreenItem[] = [
  ...
  },
  {
    href: "/action-item",
    label: "Action Item",
    description: "Pressable list actions",
  ...
  },
  {
    href: "/button",
    label: "Button",
    description: "Pressable action buttons",
    icon: "radio-button-on-outline",
  },
  {
    href: "/button-group",
    label: "Button Group",
    description: "Segmented button controls",
    icon: "apps-outline",
  },
  ...
  },
  {
    href: "/press",
    label: "Press",
    description: "Pressable touch wrapper",
  ...
  { href: "/tabs", label: "Tabs", description: "Tabbed content views", icon: "albums-outline" },
  {
    href: "/tag-group",
    label: "Tag Group",
    description: "Selectable tag chips",
  ...
  { href: "/text", label: "Text", description: "Styled text component", icon: "text-outline" },
  {
    href: "/theme",
    label: "Theme",
    description: "Theme toggle controls",
  ...
  },
  {
    href: "/tooltip",
    label: "Tooltip",
    description: "Hover/press tooltips",
