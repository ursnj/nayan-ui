...
export const NListGroup = React.memo<NListGroupProps>(
  ({ items, className, itemClassName, titleClassName, descriptionClassName, ...props }) => {
    return (
        ...
        {items.map((item) => (
          ...
          >
            ...
            <ListGroup.ItemContent>
              ...
              {item.description && (
                <ListGroup.ItemDescription className={cn(descriptionClassName)}>
                  {item.description}
