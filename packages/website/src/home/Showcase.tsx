  ...
  <Section id="what-you-get" labelledBy="what-heading">
    ...
    <div className="grid gap-4 sm:gap-5 lg:grid-cols-2">
      {PRODUCTS.map(product => {
        ...
        return (
          <Link key={product.href} href={product.href} className={`${CARD_INTERACTIVE} group flex flex-col p-6`}>
            <span className={`mb-4 flex h-11 w-11 items-center justify-center rounded-xl border ${ACCENT_SOFT}`}>
