...
export const getMenuItemByTag = (tag: string, path?: string) => {
  const sidebarItems = path
    ...
    : [...reactSidebarItems, ...reactNativeSidebarItems];
...
export const gamesSidebarItems = [
  ...
  {
    title: "Block Blast",
    description: "Strategic block placement puzzle",
  ...
  },
  {
    ...
    link: "/games/connect-em-all",
    icon: Gamepad2,
  },
  {
    title: "Bubble Shooter",
    description: "Classic bubble matching puzzle",
    link: "/games/bubble-shooter",
    icon: Gamepad2,
  },
  {
    title: "Tile Home",
    description: "Mahjong-style tile matching",
    link: "/games/tile-home",
    icon: Gamepad2,
  },
  {
    title: "Fruit Ninja",
    description: "Slice flying fruits action",
    link: "/games/fruit-ninja",
    icon: Gamepad2,
  },
  {
    title: "Fruit Merger",
    description: "Physics-based fruit merging",
    link: "/games/fruit-merger",
    icon: Gamepad2,
  },
  {
    title: "Flappy Bird",
    description: "Classic pipe navigation",
    link: "/games/flappy-bird",
    icon: Gamepad2,
  },
  {
    title: "Dino Jump",
    description: "Endless dinosaur runner",
    link: "/games/dino-jump",
    icon: Gamepad2,
  },
  {
    title: "Dots and Boxes",
    description: "Strategy territory game",
    link: "/games/dots-and-boxes",
    icon: Gamepad2,
  },
  {
    title: "Candy Crush",
    description: "Match-3 candy puzzle",
    link: "/games/candy-crush",
    icon: Gamepad2,
  },
  {
    title: "Whack A Mole",
    description: "Fast-paced reflex game",
  ...
  {
    title: "Colors Sort",
    description: "Color sorting logic puzzle",
    link: "/games/colors-sort",
    icon: Gamepad2,
  },
  {
    title: "Popit Fidget",
    description: "Relaxing bubble popping",
    link: "/games/popit-fidget",
    icon: Gamepad2,
  },
  {
    title: "Balloon Blaster",
    description: "Pop rising balloons",
    link: "/games/balloon-blaster",
    icon: Gamepad2,
  },
  {
    title: "Space Fighter",
    description: "Space survival action",
    link: "/games/space-fighter",
    icon: Gamepad2,
  },
  {
    title: "Word Search",
    description: "Find hidden words puzzle",
    link: "/games/word-search",
    icon: Gamepad2,
  },
  {
    title: "Number Search",
    description: "Find number sequences",
    link: "/games/number-search",
    icon: Gamepad2,
  },
  {
    title: "Tank 1990",
    description: "Classic tank battle",
    link: "/games/tank-1990",
    icon: Gamepad2,
  },
  {
    title: "Nuts and Bolts",
    description: "Physics bolt puzzle",
    link: "/games/nuts-and-bolts",
    icon: Gamepad2,
  },
  {
    title: "Ludo King",
  ...
  },
  {
    ...
    link: "/games/spider-solitaire",
    icon: Gamepad2,
  },
  {
    title: "Maze Runner",
    description: "Procedural maze puzzle",
    link: "/games/maze-runner",
    icon: Gamepad2,
  },
  {
    title: "Tic Tac Toe",
  ...
  {
    title: "Car Racing",
    description: "Traffic dodging racer",
    link: "/games/car-racing",
    icon: Gamepad2,
  },
  {
    title: "Bike Racing",
    description: "High-speed motorcycle racing",
    link: "/games/bike-racing",
    icon: Gamepad2,
  },
  {
    title: "Sliding Numbers",
    description: "Classic sliding tile puzzle",
    link: "/games/sliding-numbers",
    icon: Gamepad2,
  },
  {
    title: "2048",
    description: "Addictive number merging",
  ...
  },
  {
    ...
    description: "Precision drawing challenge",
    link: "/games/perfect-circle",
    icon: Gamepad2,
  },
  {
    title: "Sudoku",
  ...
  {
    title: "Block Breaker",
    description: "Brick-breaking arcade",
    link: "/games/block-breaker",
    icon: Gamepad2,
  },
  {
    title: "Knife Hit",
    description: "Knife throwing precision",
    link: "/games/knife-hit",
    icon: Gamepad2,
  },
  {
    title: "Color Switch",
    description: "Color matching arcade",
    link: "/games/color-switch",
    icon: Gamepad2,
  },
  {
    title: "Stack Tower",
    description: "Precision block stacking",
    link: "/games/stack-tower",
    icon: Gamepad2,
  },
  {
    title: "Mine Sweeper",
    description: "Classic logic deduction",
    link: "/games/mine-sweeper",
    icon: Gamepad2,
  },
  {
    title: "Snakes and Ladders",
    description: "Classic dice board game",
    link: "/games/snakes-and-ladders",
    icon: Gamepad2,
  },
  {
    title: "Find Different Number",
    description: "Spot the odd number",
    link: "/games/find-different-number",
    icon: Gamepad2,
  },
  {
    title: "Arrows",
    description: "Clear arrows off the board",
    link: "/games/arrows",
    icon: Gamepad2,
  },
  {
    title: "Pipe Connect",
    description: "Pipe rotation puzzle",
  ...
  { title: "Bluk", description: "Block slinging platformer", link: "/games/bluk", icon: Gamepad2 },
  {
    ...
    link: "/games/chameleon-run",
    icon: Gamepad2,
  },
  {
    title: "Crossy Road",
    description: "Endless road crossing",
    link: "/games/crossy-road",
    icon: Gamepad2,
  },
  {
    title: "Mob Control",
    description: "Multiplier mob strategy",
    link: "/games/mob-control",
    icon: Gamepad2,
  },
  {
    title: "Paper IO",
    description: "Territory claiming action",
    link: "/games/paper-io",
    icon: Gamepad2,
  },
  ...
  {
    title: "Checkers",
    description: "Classic board strategy",
    link: "/games/checkers",
    icon: Gamepad2,
  },
  {
    title: "Memory Match",
    description: "Card flipping memory",
    link: "/games/memory-match",
    icon: Gamepad2,
  },
  {
    title: "Falling Sticks",
    description: "Colorful stick catcher",
    link: "/games/falling-sticks",
    icon: Gamepad2,
  },
  {
    title: "Reversi",
