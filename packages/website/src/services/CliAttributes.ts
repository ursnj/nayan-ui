export const sitemapsCreateAttributes = [
  {
    ...
    type: "string",
    default: "",
    details: "The URL of the website to crawl.",
  },
  {
    ...
    default: "",
    details:
      "The URL of the website to be replaced. This will be mostly useful to crawl localhost and replace it with original URL.",
  },
  {
    name: "Crawling depth",
    attribute: "--depth / -d",
  ...
  },
  {
    ...
    default: "daily",
    details:
      "Change frequency for the sitemap. Possible options are: always, hourly, daily, weekly, monthly, yearly, never.",
  },
  {
    name: "Output",
    attribute: "--output / -o",
...
export const robotsCreateAttributes = [
  ...
  },
  {
    ...
    type: "string",
    default: "",
    details: "Sitemap url for the robots.txt.",
  },
  {
    name: "Output",
    attribute: "--output / -o",
