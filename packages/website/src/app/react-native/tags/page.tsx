...
export const metadata = buildPageMetadata({
  ...
  description:
    "Browse Nayan UI React Native components by tags and categories. Find mobile components organized by functionality and use cases.",
  path: "/react-native/tags",
  keywords:
    "react native component tags, nayan ui categories, mobile component search, ui component filter",
});
