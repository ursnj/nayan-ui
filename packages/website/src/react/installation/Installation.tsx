...
const Installation = () => (
  <Sidebar title="Installation">
    ...
    <SubHeader
      title="Configuration"
      description="Wire Tailwind up, then import the library's styles and theme tokens."
    >
      <Code code={tailwindCode} filename="vite.config.ts" />
      <p className="mb-4 mt-6 text-sm leading-relaxed text-muted">
        Add the library styles to{" "}
        <code className="font-mono text-xs text-foreground">index.css</code>. The theme colour
        variables can be overridden here for both light and dark modes.
      </p>
    ...
    <SubHeader
      title="Usage"
      description="Wrap the tree in NTheme once; components can then be imported anywhere."
    >
