...
export const buttonAttributes = [
  ...
  },
  {
    ...
    type: "boolean",
    default: "false",
    details: "You can pass this to create outline button.",
  },
  {
    name: "isLoading",
    type: "boolean",
    default: "false",
    details: "You can pass this to show loading indication.",
  },
  {
    name: "loadingText",
    type: "string",
    default: "' '",
    details: "You can pass this to show customised loading text.",
  },
  {
    name: "leftIcon",
    type: "React.ReactNode",
    default: "Optional",
    details: "Icon to display on the left side of button.",
  },
  {
    name: "rightIcon",
    type: "React.ReactNode",
    default: "Optional",
    details: "Icon to display on the right side of button.",
  },
  {
    name: "children",
    type: "React.ReactNode",
    default: "Required",
    details: "You can pass button content as children.",
  },
];
