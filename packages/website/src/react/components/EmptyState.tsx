...
export const emptyStateAttributes = [
  ...
  { name: "message", type: "ReactNode", default: "Optional", details: "The message prop." },
  {
    ...
    type: "ReactNode",
    default: "Optional",
    details: "Shown above the title — an icon or a small illustration.",
  },
  {
    name: "actions",
    type: "ReactNode",
    default: "Optional",
    details: "Buttons or links under the message.",
  },
  ...
  { name: "titleClassName", type: "string", default: "''", details: "The titleClassName prop." },
  {
    ...
    type: "string",
    default: "''",
    details: "The messageClassName prop.",
  },
  {
    name: "actionsClassName",
    type: "string",
    default: "''",
    details: "The actionsClassName prop.",
  },
