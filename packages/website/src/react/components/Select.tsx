  ...
  return (
    <ComponentWrapper code={code} attributes={selectAttributes}>
      {mounted ? (
        ...
        <div
          className="h-[68px] animate-pulse rounded-lg border border-default bg-surface"
          aria-hidden
        />
      )}
    </ComponentWrapper>
...
export const selectAttributes = [
  {
    ...
    type: "boolean",
    default: "false",
    details: "You can pass isMulti option to switch between single / multi select.",
  },
  { name: "label", type: "string", default: "Optional", details: "Label for the select field." },
  {
    ...
    type: "string",
    default: "Optional",
    details: "Placeholder text for the select.",
  },
  {
    name: "isLoading",
    type: "boolean",
    default: "false",
    details: "Whether the select is in loading state.",
  },
  {
    name: "isCreatable",
    type: "boolean",
    default: "false",
    details: "Whether new options can be created.",
  },
  {
    name: "isClearable",
    type: "boolean",
    default: "false",
    details: "Whether the selection can be cleared.",
  },
  {
    name: "isSearchable",
    type: "boolean",
    default: "true",
    details: "Whether the select is searchable.",
  },
  {
    name: "disabled",
    type: "boolean",
    default: "false",
    details: "Whether the select is disabled.",
  },
  {
    name: "className",
    type: "string",
  ...
  },
  {
    ...
    default: "Required",
    details: "Selected value(s).",
  },
  {
    name: "options",
    type: "OptionType[]",
    default: "Required",
    details: "Array of available options.",
  },
  {
    name: "onCreateOption",
    type: "(inputValue: string) => void",
    default: "Optional",
    details: "Callback when new option is created.",
  },
  {
    name: "onChange",
  ...
  },
  {
    ...
    default: "Optional",
    details: "Function to get option label.",
  },
  {
    name: "getOptionValue",
    type: "(option: OptionType) => string",
    default: "Optional",
    details: "Function to get option value.",
  },
  ...
  { name: "name", type: "string", default: "Optional", details: "Name attribute for the select." },
  {
    ...
    type: "HTMLElement",
    default: "Optional",
    details: "Target element for menu portal.",
  },
];
