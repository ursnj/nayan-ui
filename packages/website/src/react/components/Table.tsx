...
export const tableAttributes = [
  ...
  {
    name: "bodyRowClassName",
    type: "string",
    default: "' '",
    details: "You can customise by passing tailwind classes.",
  },
  {
    name: "bodyCellClassName",
    type: "string",
    default: "' '",
    details: "You can customise by passing tailwind classes.",
  },
  { name: "caption", type: "string", default: "Optional", details: "Caption for the table." },
  {
    ...
    type: "NTableColumn<T>[]",
    default: "Required",
    details: "Array of table columns.",
  },
  { name: "data", type: "T[]", default: "Required", details: "Array of table data." },
  {
    ...
    default: "Optional",
    details: "Props for table element.",
  },
  {
    name: "rowProps",
  ...
  },
  {
    ...
    default: "'primary'",
    details: "Visual variant of the table.",
  },
  {
    name: "emptyMessage",
    type: "React.ReactNode",
    default: "Optional",
    details: "Content shown when table has no data.",
  },
  {
    name: "getRowKey",
    type: "(row: T, index: number) => string | number",
    default: "Optional",
    details: "Custom key extractor for table rows.",
  },
];
