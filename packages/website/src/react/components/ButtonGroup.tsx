...
export const buttonGroupAttributes = [
  ...
  },
  {
    ...
    type: "T[]",
    default: "Required",
    details: "You can pass items for the button group.",
  },
  {
    name: "selected",
    type: "T",
    default: "Required",
    details: "You can pass default selected item.",
  },
  {
    name: "disabled",
    type: "boolean",
    default: "false",
    details: "You can pass disable state to disable items.",
  },
  {
    name: "onChange",
    type: "(selected: T) => void",
    default: "Required",
    details: "You can get callback when button group changed.",
  },
  {
    name: "keyExtractor",
    type: "(item: T, idx: number) => string | number",
    default: "Optional",
    details: "Custom key extractor function.",
  },
  {
    name: "renderButton",
  ...
  { name: "value", type: "T", default: "Optional", details: "Alias of selected." },
  {
    ...
    default: "Optional",
    details: "Custom key extractor for items.",
  },
  {
    name: "renderItem",
    type: "(item: T, index: number) => ReactNode",
    default: "Optional",
    details: "Custom render function for button items.",
  },
  {
    name: "size",
    type: "'sm' | 'md' | 'lg'",
    default: "'md'",
    details: "Size of the button group.",
  },
];
