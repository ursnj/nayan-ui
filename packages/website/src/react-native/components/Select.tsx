...
export const selectAttributes = [
  {
    ...
    type: "SelectOption[]",
    default: "Required",
    details: "Array of select options with label and value.",
  },
  {
    name: "onValueChange",
  ...
  { name: "label", type: "string", default: "Optional", details: "Label above the select." },
  {
    ...
    type: "string",
    default: "Optional",
    details: "Label shown inside the dropdown list.",
  },
  {
    name: "placeholder",
    type: "string",
    default: "Optional",
    details: "Placeholder text for the select trigger.",
  },
  {
    name: "defaultValue",
    type: "SelectOption",
    default: "Optional",
    details: "Default selected option.",
  },
  {
    name: "isDisabled",
    type: "boolean",
  ...
  },
  {
    ...
    type: "string",
    default: "' '",
    details: "You can customise trigger by passing tailwind classes.",
  },
  { name: "disabled", type: "boolean", default: "false", details: "Alias of isDisabled." },
  {
    ...
    type: "SelectOption",
    default: "Optional",
    details: "Controlled selected option.",
  },
