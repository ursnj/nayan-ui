      ...
      <Modal>
        <Modal.Backdrop
          ...
          <Modal.Container size={sizeMapping[size]}>
            <Modal.Dialog
              className={cn('nyn-dialog p-0 border border-default bg-surface text-white rounded overflow-hidden', maxWidthMapping[size], className)}>
              ...
              <Modal.Body
                className={cn(
                  'nyn-dialog-content text-foreground h-[calc(100vh_-_140px)] sm:h-auto sm:min-h-[100px] sm:max-h-[calc(100vh_-_75px)] overflow-y-auto',
                  contentClassName
                )}>
                {children}
              </Modal.Body>
