...
const NCodeComponent: React.FC<NCodeProps> = memo(
  ({ code, language = "tsx", theme = THEMES.LIGHT, copied = false, onCopy, className }) => {
    return (
      <div className={cn("nyn-code relative group", className)}>
        ...
        <Highlight
          theme={theme === THEMES.LIGHT ? themes.github : themes.dracula}
          code={code}
          language={language}
        >
