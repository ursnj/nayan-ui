...
const Component = () => {
  ...
  return (
    <ScrollView className="flex-1 bg-surface p-4">
      ...
      <NText className="text-xl font-bold mb-3 text-foreground">Typography Hierarchy</NText>
      ...
      <NCard className="p-4 mb-6">
        <View className="space-y-4">
          ...
          <View>
            ...
            <NText className="text-4xl font-bold text-foreground mb-2">Heading 1 - 4xl</NText>
            <NText className="text-3xl font-bold text-foreground mb-2">Heading 2 - 3xl</NText>
            <NText className="text-2xl font-bold text-foreground mb-2">Heading 3 - 2xl</NText>
            <NText className="text-xl font-bold text-foreground mb-2">Heading 4 - xl</NText>
            <NText className="text-lg font-bold text-foreground mb-2">Heading 5 - lg</NText>
            <NText className="text-base font-bold text-foreground">Heading 6 - base</NText>
          </View>

          {/* Body Text */}
          <View>
            <NText className="text-muted text-sm mb-2">Body Text</NText>
            <NText className="text-lg text-foreground mb-2">Large body text - Perfect for introductions and important content.</NText>
            <NText className="text-base text-foreground mb-2">Regular body text - The standard text size for most content and paragraphs.</NText>
            <NText className="text-sm text-foreground mb-2">Small body text - Used for secondary information and details.</NText>
            <NText className="text-xs text-foreground">Extra small text - For captions, labels, and fine print.</NText>
          </View>
        </View>
      </NCard>

      {/* Font Weights */}
      <NText className="text-xl font-bold mb-3 text-foreground">Font Weights</NText>

      <NCard className="p-4 mb-6">
        <View className="space-y-3">
          <NText className="font-thin text-foreground">Thin weight (100) - Very light text</NText>
          <NText className="font-extralight text-foreground">Extra light weight (200) - Lighter than normal</NText>
          <NText className="font-light text-foreground">Light weight (300) - Light text</NText>
          <NText className="font-normal text-foreground">Normal weight (400) - Regular text</NText>
          <NText className="font-medium text-foreground">Medium weight (500) - Slightly bold</NText>
          <NText className="font-semibold text-foreground">Semibold weight (600) - Semi bold text</NText>
          <NText className="font-bold text-foreground">Bold weight (700) - Bold text</NText>
          <NText className="font-extrabold text-foreground">Extra bold weight (800) - Very bold</NText>
          <NText className="font-black text-foreground">Black weight (900) - Heaviest weight</NText>
        </View>
      </NCard>

      {/* Colors and Themes */}
      <NText className="text-xl font-bold mb-3 text-foreground">Colors and Themes</NText>
      ...
      <NCard className="p-4 mb-6">
        <View className="space-y-4">
          ...
          <View>
            ...
            <NText className="text-foreground mb-1">Primary text color</NText>
      ...
      {/* Text Alignment */}
      <NText className="text-xl font-bold mb-3 text-foreground">Text Alignment</NText>

      <NCard className="p-4 mb-6">
        <View className="space-y-4">
          <View className="p-3 border border-gray-200 rounded">
            <NText className="text-left text-foreground">Left aligned text - This is the default alignment for most text content.</NText>
          </View>
          <View className="p-3 border border-gray-200 rounded">
            <NText className="text-center text-foreground">Center aligned text - Perfect for headings and important announcements.</NText>
          </View>
          <View className="p-3 border border-gray-200 rounded">
            <NText className="text-right text-foreground">Right aligned text - Often used for numbers and dates.</NText>
          </View>
          <View className="p-3 border border-gray-200 rounded">
            <NText className="text-justify text-foreground">
      ...
      {/* Text Decorations */}
      <NText className="text-xl font-bold mb-3 text-foreground">Text Decorations</NText>

      <NCard className="p-4 mb-6">
        <View className="space-y-3">
          <NText className="underline text-foreground">Underlined text - Often used for links</NText>
          <NText className="line-through text-foreground">Strikethrough text - Shows deleted or outdated content</NText>
          <NText className="no-underline text-blue-500">No underline - Removes default link styling</NText>
          <NText className="uppercase text-foreground">UPPERCASE TEXT - ALL CAPS</NText>
          <NText className="lowercase text-foreground">lowercase text - all lowercase</NText>
          <NText className="capitalize text-foreground">capitalized text - first letter of each word</NText>
          <NText className="italic text-foreground">Italic text - Emphasized or stylized</NText>
          <NText className="not-italic text-foreground">Not italic - Removes italic styling</NText>
        </View>
      </NCard>

      {/* Interactive Text */}
      <NText className="text-xl font-bold mb-3 text-foreground">Interactive Text</NText>
      ...
      {/* Text Truncation */}
      <NText className="text-xl font-bold mb-3 text-foreground">Text Truncation</NText>
        ...
        <View className="space-y-4">
          ...
          <View>
            ...
            <View className="border border-gray-200 rounded p-3">
              <NText className="text-foreground truncate" numberOfLines={1}>
          ...
          <View>
            ...
            <View className="border border-gray-200 rounded p-3">
              <NText className="text-foreground" numberOfLines={3}>
                {longText}
              </NText>
            </View>
          </View>
          ...
          <View>
            ...
            <View className="border border-gray-200 rounded p-3">
              <NText className="text-foreground" numberOfLines={showMore ? undefined : 2}>
                {longText}
              </NText>
      ...
      {/* Practical Examples */}
      <NText className="text-xl font-bold mb-3 text-foreground">Practical Examples</NText>
        ...
        <View className="space-y-6">
          ...
          <View>
            ...
            <View className="p-4 border border-gray-200 rounded">
              <NText className="text-2xl font-bold text-foreground mb-2">Article Title</NText>
              <NText className="text-sm text-muted mb-4">Published on January 15, 2024 • 5 min read</NText>
              <NText className="text-base text-foreground leading-6 mb-4">
                This is the article introduction paragraph. It provides a brief overview of what the reader can expect from the content.
              </NText>
              <NText className="text-lg font-semibold text-foreground mb-2">Section Heading</NText>
              <NText className="text-base text-foreground leading-6">
          ...
          <View>
            ...
            <View className="p-4 border border-gray-200 rounded">
              <NText className="text-xl font-bold text-foreground mb-1">John Doe</NText>
              <NText className="text-sm text-blue-600 mb-2">@johndoe</NText>
              <NText className="text-base text-foreground mb-3">Software Developer passionate about React Native and mobile development.</NText>
      ...
      {/* Accessibility */}
      <NText className="text-xl font-bold mb-3 text-foreground">Accessibility</NText>
      ...
      <NCard className="p-4 mb-6">
        <View className="space-y-4">
          ...
          <View>
            ...
            <NText className="text-xl text-foreground leading-8">Larger text size with increased line height for better readability</NText>
          </View>
        </View>
      </NCard>
