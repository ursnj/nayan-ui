...
export default function GameScreen() {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle: () => (
        <View
          className={`${Platform.OS === "ios" ? "mr-10" : ""} flex-1 items-center justify-center`}
        >
      ...
      headerLeft: () => (
        <NPress
          ...
          className="z-10 flex items-center justify-center h-10 w-10 rounded-full"
        >
      ...
      headerRight: () => (
        <NPress
          onPressIn={handleToggleSettingsModal}
          className="z-10 flex items-center justify-center h-10 w-10 rounded-full"
        >
