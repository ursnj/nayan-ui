...
import { NButton, NCard, NDialog, NInput, NSelect, NSwitch, NText, NToast, type SelectOption } from '@nayan-ui/react-native';
...
const Component = () => {
  ...
  const [settingsForm, setSettingsForm] = useState({
    ...
    syncData: false,
    showTips: true,
    theme: { label: 'Light', value: 'light' } as SelectOption,
    fontSize: { label: 'Medium', value: 'medium' } as SelectOption
  });
    ...
    <ScrollView className="flex-1 bg-background p-4">
        ...
        <NDialog
          ...
          <View className="p-4">
            <View className="flex-row items-center justify-between mb-3">
              ...
              <NSwitch checked={settingsForm.autoSave} onChange={value => setSettingsForm(prev => ({ ...prev, autoSave: value }))} />
            </View>

            <View className="flex-row items-center justify-between mb-3">
              <NText className="text-text">Sync Data</NText>
              <NSwitch checked={settingsForm.syncData} onChange={value => setSettingsForm(prev => ({ ...prev, syncData: value }))} />
            </View>

            <View className="flex-row items-center justify-between mb-4">
              <NText className="text-text">Show Tips</NText>
              <NSwitch checked={settingsForm.showTips} onChange={value => setSettingsForm(prev => ({ ...prev, showTips: value }))} />
            </View>
            ...
            <NSelect
              ...
              onChange={value => setSettingsForm(prev => ({ ...prev, fontSize: value }))}
              items={[
      ...
      <NCard className="mt-4">
        ...
        <View className="space-y-2">
          ...
          <NText className="text-sm text-muted">
            Settings: Auto-save {settingsForm.autoSave ? 'ON' : 'OFF'}, Theme: {settingsForm.theme.label}
          </NText>
