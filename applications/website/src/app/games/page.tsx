...
export const metadata = buildPageMetadata({
  ...
  path: "/games",
  keywords:
    "react native games, mobile games, react native game library, puzzle games, arcade games, nayan ui games",
});
...
const schemas = [
  ...
  ]),
  {
    ...
    description:
      "50 high-performance games for React Native applications built with Skia, Reanimated and TypeScript.",
    url: `${SITE_URL}/games`,
