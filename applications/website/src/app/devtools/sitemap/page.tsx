...
export const metadata = buildPageMetadata({
  ...
  description:
    "Generate and validate XML sitemaps for better SEO optimization. Free online sitemap generator tool by Nayan UI.",
  path: "/devtools/sitemap",
  keywords:
    "sitemap generator, xml sitemap, seo optimization, sitemap validator, nayan ui devtools",
});
