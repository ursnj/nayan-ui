...
export const metadata = buildPageMetadata({
  ...
  description:
    "Create and validate robots.txt files for search engine crawling control. Free online robots.txt generator tool by Nayan UI.",
  path: "/devtools/robots",
  keywords:
    "robots.txt generator, search engine crawling, seo tools, robots txt validator, nayan ui devtools",
});
