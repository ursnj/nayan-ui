...
const AICodeScanner = () => {
  return (
    <div>
      ...
      <h2 className={H2_DOC}>Supported Project Types</h2>
      <div className="overflow-x-auto mb-5">
        <table className="w-full text-sm border border-default rounded-lg">
          <thead>
            <tr className="bg-default/30">
