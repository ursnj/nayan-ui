...
const SEOSitemaps = () => {
  return (
    <div>
      ...
      <Code
        language="bash"
        code={`npx @nayan-ui/cli create sitemap -w https://www.nayanui.com -d 10 -f daily -o ./sitemap.xml`}
      />
      ...
      />
      <div className="mb-5">
        In this case it will crawl your localhost URL and replace it with the replacement URL in the
        generated sitemap.
      </div>
      ...
      <Code
        code={`npx @nayan-ui/cli validate sitemap --input https://www.nayanui.com/sitemap.xml --isremote true`}
      />
