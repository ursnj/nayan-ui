...
const linkClass =
  "text-sm text-muted transition-colors hover:text-indigo-600 dark:hover:text-indigo-400";
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5 lg:gap-8">
          <div className="sm:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-muted">
              Open source React and React Native components, a browser video editor and a few
              developer tools. Free forever, MIT licensed.
            </p>
                ...
                {PACKAGES.map((pkg) => (
                  <li key={pkg.label}>
                    <Link
                      ...
                      className={`${PILL_INTERACTIVE} font-mono`}
                    >
                      {pkg.label}
                    </Link>
                  </li>
