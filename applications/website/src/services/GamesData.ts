...
export const gamesData: Record<string, GameData> = {
  ...
  "snakes-and-ladders": {
    ...
    category: "Strategy",
    description:
      "Classic board game - roll the dice, climb ladders, and avoid snakes to reach 100!",
    longDescription:
  ...
  bluk: {
    ...
    category: "Arcade",
    description:
      "Sling your block from pillar to pillar - a skill-based physics jumping adventure!",
    longDescription:
  ...
  "chameleon-run": {
    ...
    category: "Arcade",
    description:
      "Dash across colorful platforms - match your color and leap over gaps in this fast runner!",
    longDescription:
  ...
  "crossy-road": {
    ...
    category: "Arcade",
    description:
      "Hop across busy roads, rivers and railways - how far can you go without getting squished?",
    longDescription:
  ...
  "paper-io": {
    ...
    category: "Strategy",
    description:
      "Claim territory, outmaneuver rivals and conquer the board in this classic io battle!",
    longDescription:
  ...
  tangram: {
    ...
    category: "Puzzle",
    description:
      "Arrange the seven classic tans to perfectly fill the target shape - a timeless dissection puzzle!",
    longDescription:
  ...
  checkers: {
    ...
    category: "Strategy",
    description:
      "Outsmart the robot in the classic game of Checkers - capture all its pieces to win!",
    longDescription:
  ...
  reversi: {
    ...
    category: "Strategy",
    description:
      "Outflank the robot in this classic Othello duel - trap its discs to flip them to your color!",
    longDescription:
